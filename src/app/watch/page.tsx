    ...
    return (
        <div className="flex h-screen overflow-hidden" style={{ background: 'var(--bg-primary)' }}>
            ...
            <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden ml-0 lg:ml-4">
                ...
                <main className="flex-1 overflow-y-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 scrollbar-hide">
                ...
                {/* Site Footer */}
                <footer className="mt-auto py-6 px-4 sm:px-6 lg:px-8 border-t" style={{
